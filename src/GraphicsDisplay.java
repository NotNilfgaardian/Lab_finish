...
public class GraphicsDisplay extends JPanel
{
    ...
    public void showGraphics(ArrayList<Double[]> graphicsData)
    {
        ...
        for (Double[] point : graphicsData)
        {
            ...
            newPoint[0] = new Double(point[0]);
            newPoint[1] = new Double(point[1]);
    ...
    private void paintLabels(Graphics2D canvas)
    {
        ...
        if (selectedMarker >= 0)
        {
            Point2D.Double point = xyToPoint(( graphicsData.get(selectedMarker))[0],
                    ( graphicsData.get(selectedMarker))[1]);
    ...
    public class MouseMotionHandler implements MouseMotionListener
    {
        ...
        public void mouseDragged(MouseEvent ev)
        {
            if (changeMode)
            {
                ...
                double newY = ( graphicsData.get(selectedMarker))[1] +
                        (currentPoint[1] - ( graphicsData.get(selectedMarker))[1]);
